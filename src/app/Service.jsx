         ...
         <div className=" lg:px-24 md:px-10 px-2 mt-20 flex flex-col md:flex-wrap lg:flex-row">
            ...
            <div className=" lg:w-1/3 md:2/3 w-1/1 p-3 mt-8 lg:mt-0">
              ...
              <div className="bg-white rounded-3xl p-10  shadow-lg">
                <div  className="bg-gray-200  bg-center bg-no-repeat bg-contain bg-[length:70px_70px] border border-slate-100  -mt-20 rounded-full absolute bg-[url('/img/service/general.png')] w-24 h-24"  ></div>
             ...
             <div className="lg:w-1/3 md:2/3 w-1/1 p-3 mt-8 lg:mt-0 ">
              <div className="bg-blue-600 text-white rounded-3xl p-10 shadow-lg ">
               <div  className="bg-gray-200   bg-center bg-no-repeat bg-contain bg-[length:70px_70px] border border-slate-100  -mt-20 rounded-full absolute bg-[url('/img/service/repaire.png')] w-24 h-24"  ></div>
             ...
             <div className="lg:w-1/3 mt-8 lg:mt-0 md:2/3 w-1/1 p-3">
              <div className="bg-white rounded-3xl p-10 shadow-lg">
               <div  className="bg-gray-200  bg-center bg-no-repeat bg-contain bg-[length:70px_70px] border border-slate-100  -mt-20 rounded-full absolute bg-[url('/img/service/fixure.png')] w-24 h-24" ></div>
