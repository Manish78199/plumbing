            ...
            <div className=" lg:w-1/3 md:2/3 w-1/1 p-3 lg:mt-0">
              ...
              <div className="bg-white  p-5  rounded-md">
                ...
                <h2 className="text-2xl  ">Call us</h2>
                 <div className=" mt-3 flex items-center gap-x-1 content-center"><img src="/img/contact/call.png" width="25" height="25"/> 456713598</div>
              </div>
            </div>
              ...
              <div className="bg-white  p-5 rounded-md ">
                ...
                <h2 className="text-2xl  ">Message us</h2>
                  <div className=" mt-3 flex items-center gap-x-1 content-center"><img src="/img/contact/whatsapp.png" width="25" height="25"/> 456713598</div>
              ...
              <div className="bg-white  p-5 rounded-md ">
                ...
                <h2 className="text-2xl  ">Mail us</h2>
                  <div className=" mt-3 flex items-center gap-x-1 content-center"><img src="/img/contact/email.png" width="25" height="25"/> 456713598</div>
              </div>
            </div>
              ...
              <div className=" lg:px-24 md:px-10 px-2  flex flex-col justify-center  md:flex-wrap lg:flex-row">
                ...
                {/*<h2 className="text-2xl  ">Follow us on: </h2>*/}
                 <div className=" mt-3 flex gap-x-4 items-center  content-center">
                 <img src="/img/contact/facebook.png" width="30" height="30" alt="facebook"/>
                  ...
                  <img src="/img/contact/google.png" width="30" height="30" alt="google"/> </div>
              </div>
