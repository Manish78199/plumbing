        ...
        <div className=" lg:px-24 md:px-10 px-2 mt-20 flex flex-col md:flex-wrap lg:flex-row">
          ...
          <div className=" lg:w-1/3 md:2/3 w-1/1 p-3 lg:mt-0">
            ...
            <div className="bg-white  p-5  rounded-md">
              ...
              <div className=" mt-3 flex items-center gap-x-1 content-center"><img src="/img/contact/call.png" width="25" height="25" /> 73105 73878</div>
            </div>
          </div>
          ...
          <div className=" lg:w-1/3 md:2/3 w-1/1 p-3 lg:mt-0">
            ...
            <div className="bg-white  p-5 rounded-md ">
              ...
              <div className=" mt-3 flex items-center gap-x-1 content-center"><img src="/img/contact/email.png" width="25" height="25" /> Contact.GreenLinePlumbing@gmail.com</div>
            </div>
          </div>
